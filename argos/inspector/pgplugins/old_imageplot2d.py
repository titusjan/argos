...
class PgImagePlot2dCti(MainGroupCti):
    ...
    def __init__(self, pgImagePlot2d, nodeName):
        ...
        self.pgImagePlot2d.imagePlotItem.sigResetAxis.connect(self.setImagePlotAutoRangeOn,
                                                              type=Qt.QueuedConnection)
        self.pgImagePlot2d.horCrossPlotItem.sigResetAxis.connect(self.setHorCrossPlotAutoRangeOn,
                                                                 type=Qt.QueuedConnection)
        self.pgImagePlot2d.verCrossPlotItem.sigResetAxis.connect(self.setVerCrossPlotAutoRangeOn,
                                                                 type=Qt.QueuedConnection)
    ...
    def resetRangesToDefault(self):
        ...
        self.histColorRangeCti.autoRangeCti.data = True
        self.histRangeCti.autoRangeCti.data = True
